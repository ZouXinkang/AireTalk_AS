...
//	abstract public VoipCore createVoipCore(VoipCoreListener listener, String stun, int audio_port, int video_port, int mode, int monotor) throws VoipCoreException;
	//sw|vivid*** webcall
