...
public final class VideoSize {
	...
	public static final int HD480p = 10;
	...
	public static final VideoSize createStandard(int code, boolean inverted) {
		...
		case SVGA:
			return inverted? new VideoSize(600, 800) : new VideoSize(800, 600);  //VideoSize(600, 800) : new VideoSize(800, 600);
		case HD720pM:
			return inverted? new VideoSize(720, 960) : new VideoSize(960, 720);
		case HD720p:
			return inverted? new VideoSize(720, 1280) : new VideoSize(1280, 720);
		case HD1080p:
			return inverted? new VideoSize(1200, 1600) : new VideoSize(1600, 1200);  //tml|sw*** hd2
//			return inverted? new VideoSize(1080, 1920) : new VideoSize(1920, 1080);  //tml|sw*** hd2
		case HD480p:
			return inverted? new VideoSize(480, 848) : new VideoSize(848, 480);  //tml|sw*** new vidsize
		default:
