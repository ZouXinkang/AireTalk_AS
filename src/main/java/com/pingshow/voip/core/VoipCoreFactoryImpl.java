...
public class VoipCoreFactoryImpl extends VoipCoreFactory {
	...
	@Override
//	public VoipCore createVoipCore(VoipCoreListener listener, String stun, int audio_port, int video_port, int mode, int monotor) throws VoipCoreException {
	//sw|vivid*** webcall
	public VoipCore createVoipCore(VoipCoreListener listener, String stun, int audio_port, int video_port, int mode, int monotor, int hd, int siptype) throws VoipCoreException {
		try {
//			return new VoipCoreImpl(listener, stun, audio_port, video_port, mode, monotor);
			//sw|vivid*** webcall
			return new VoipCoreImpl(listener, stun, audio_port, video_port, mode, monotor, hd, siptype);
		} catch (IOException e) {
