...
import com.pingshow.amper.view.SwipeMenuLayout.SwipeMenuAdapter;
import com.pingshow.amper.view.SwipeMenuLayout.SwipeMenuListView;
import com.pingshow.amper.view.indexableListView.help.PinyinUtil;
...
public class IndexBar extends View {
    ...
    void setListView(ListView indexListView) {
        mIndex.clear();
        mListView = (SwipeMenuListView) indexListView;

        ListAdapter listAdapter = mListView.getAdapter();
        if (listAdapter instanceof SwipeMenuAdapter) {
            mAdapter =  ((SwipeMenuAdapter)listAdapter).getRealAdapter();
        }
