...
import com.pingshow.amper.FriendsAdapter;
...
public class SwipeMenuListView extends ListView {
	...
	private IndexBarAdapter dataAdapter;
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			Log.d("SwipeMenuListView", "mTouchPosition:" + mTouchPosition);
			if (mTouchPosition==1||mTouchPosition==2) {
				return true;
			}
