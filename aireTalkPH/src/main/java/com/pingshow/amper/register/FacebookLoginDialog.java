...
public class FacebookLoginDialog extends Activity{
	...
	private boolean downloadPhoto(String remote, String uid) 
	{
		...
		try {
			...
			Log.e("fb downloadPhoto !@#$ " + e.getMessage());
		}
		return false;
	}
	...
	public class UserRequestListener extends BaseRequestListener {
        ...
        public void onComplete(final String response, final Object state) {
            ...
            try {
		    			...
		    			try{
			    			...
			    			do {
								...
								Return=net.doPostHttps("preregister_aire.php", "id=" + URLEncoder.encode(username,"UTF-8")
											...
											+"&acct=0",null);
								Log.d("preregister_aireFb=" + email + " " + URLEncoder.encode(email, "UTF-8"));
								Log.d("preregister_aireFb Return="+Return);
                ...
                Log.e("fb UserRequestListener1 !@#$ " + e.getMessage());
            } catch (Exception e) {
                Log.e("fb UserRequestListener2 !@#$ " + e.getMessage());
            }
        }
