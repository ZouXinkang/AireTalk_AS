...
public class WebCallSplash extends Activity{
	...
	void checkServiceX()
	{
		...
		if (mPref.readBoolean("Registered",false))
		{
			if (!MyUtil.CheckServiceExists(WebCallSplash.this, "com.pingshow.amper.AireJupiter"))//Start ServiceX
	        {
			...
			if (MyUtil.CheckServiceExists(WebCallSplash.this, "com.pingshow.amper.AireJupiter"))//Stop ServiceX
	        {
	    		Intent x=new Intent(WebCallSplash.this, AireJupiter.class);
	    		stopService(x);
	    	}
