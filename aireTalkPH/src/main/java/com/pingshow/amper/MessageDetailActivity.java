...
public class MessageDetailActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int att=intent.getIntExtra("attachment", 0);
		String msgContent=intent.getStringExtra("msgContent");
		
		if (imagePath!=null && MyUtil.checkSDCard(this))
		{
			try {
				...
				if (att==16)
				{
					...
					html="<html><head><meta http-equiv='content-type' content='text/html; charset=UTF-8'/></head><body bgcolor=#000000><div style='width:100%'>" +
						"<table width='100%' height='100%' border=0 cellpadding=0 cellspacing=0 style='position:relative'>" +
						"<td style='vertical-align:middle'><img src='"+relative+"' "+(display_mode==1?"width='100%'":"height='100%'")+">" +
						"</br><p><font size=6 color=white>"+msgContent+"</font></p></td></table></div></body></html>";
				}else
					html="<html><body bgcolor=#000000><div style='width:100%'>" +
						"<table width='100%' height='100%' border='0' cellpadding='0' cellspacing='0' style='position:relative'>" +
		...
		if (msgContent!=null && msgContent.length()>0 && att!=16)
		{
	...
	*/
	...
	public void onPlayVoiceMemo(String path){
		...
		try {
			...
			Log.e("Message playvoice1 !@#$ " + e.getMessage());
			vmp = null;
			myVP = null;
			return;
		} catch (IllegalArgumentException e) {
			Log.e("Message playvoice2 !@#$ " + e.getMessage());
			vmp = null;
			myVP = null;
			return;
		}catch (IllegalStateException e) {
			Log.e("Message playvoice3 !@#$ " + e.getMessage());
			vmp = null;
			myVP = null;
			return;
		}
	...
	protected void onDestroy()
	{
		try{
			...
			vmp=null;
			myVP = null;
			Log.e("Message onDestroy !@#$ " + e.getMessage());
		}
